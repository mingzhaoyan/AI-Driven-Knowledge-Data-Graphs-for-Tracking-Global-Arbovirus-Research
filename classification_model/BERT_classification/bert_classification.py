...
model_path = '/home/tian/Documents/pythonProject/.vscode/BERTmodel'  # Replace with your local model path
...
def evaluate(model, test_data, threshold):
    ...
    with open('bertoutput.log', 'a') as log_file:  # Replace with your desired log file path if needed
