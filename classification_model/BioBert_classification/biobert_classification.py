...
model_path = '/home/tian/Documents/pythonProject/.vscode/biobert'  # Replace with your local model path
...
def evaluate(model, test_data, threshold):
    ...
    with open('biobertoutput.log', 'a') as log_file:  # Replace with your desired log file path if needed
